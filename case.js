...
url: 'https://github.com/ZhaaLL24/BOTMD'
}
}]
neo.send5ButImg(m.chat, fitur, `Base Ori : ZhaaLL Official\nNo Encrypt Full Compress\nFitur Full Scrape Dan No Error`, log0, btnR)
}
break
...
neo.sendMessage("6283816171576@s.whatsapp.net", util.format(err), {quoted:m})
console.log(err)
}
}
